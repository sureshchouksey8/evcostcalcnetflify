// --- Benchmarks ---
var BENCH_KMPL = {"City car":20,"Hatchback":17,"Compact SUV":16,"Sedan":16,"SUV":14,"Crossover":12,"MPV/SUV":15,"Scooter":50};

// --- City presets (petrol ₹/L, tariff ₹/kWh; coarse but OK) ---
var CITY_PRESETS = [
  {id:"gurugram", name:"Gurugram", petrol:100, tariff:6.8},
  {id:"delhi", name:"Delhi", petrol:95, tariff:6.0},
  {id:"mumbai", name:"Mumbai", petrol:105, tariff:8.5},
  ...
  {id:"pune", name:"Pune", petrol:105, tariff:7.0},
  {id:"kolkata", name:"Kolkata", petrol:106, tariff:8.0},
  {id:"ahmedabad", name:"Ahmedabad", petrol:95, tariff:7.1},
  {id:"jaipur", name:"Jaipur", petrol:105, tariff:8.1},
  {id:"chandigarh", name:"Chandigarh", petrol:97, tariff:6.4}
];
